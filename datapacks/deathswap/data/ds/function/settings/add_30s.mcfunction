execute if score timeCycle Core matches 500.. run title @a title {"text":"Can't go higher!","color":"gold"}
execute if score timeCycle Core matches 500.. if score Lang Core matches 1 run title @a subtitle "Swap cycle can't get any higher!"
execute if score timeCycle Core matches 500.. if score Lang Core matches 2 run title @a subtitle "交换周期不能再大了!"

execute as @a at @s run playsound minecraft:ui.button.click master @s ~ ~ ~ 9

execute if score timeCycle Core matches ..450 if score Lang Core matches 1 run title @a subtitle "Swap cycle raised to this length!"
execute if score timeCycle Core matches ..450 if score Lang Core matches 2 run title @a subtitle "交换周期增加到这个长度!"
execute if score timeCycle Core matches ..450 run scoreboard players add timeCycle Core 50
