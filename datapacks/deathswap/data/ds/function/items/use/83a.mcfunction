...
execute if score noNatRegen Core matches 0 if score Lang Core matches 2 run tellraw @a [{"text":">> ","color":"green"},{"selector":"@s","bold":false}," --> ",{"text":"已关闭游戏规则'自然再生'!","color":"aqua"}]
execute if score noNatRegen Core matches 1 if score Lang Core matches 2 run tellraw @a [{"text":">> ","color":"green"},{"selector":"@s","bold":false}," --> ",{"text":"重新开启了游戏规则'自然再生'!","color":"aqua"}]
...
execute if score noNatRegen Core matches 0 if score Lang Core matches 2 run title @a subtitle "/gamerule 游戏规则'自然再生'已关闭!"
