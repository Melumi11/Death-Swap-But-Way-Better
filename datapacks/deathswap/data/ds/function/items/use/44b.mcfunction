...
$scoreboard players set @p[scores={permPNo=$(s)}] huge_scale 5000
...
$tellraw @a [{"text":">> ","color":"green"},{"selector":"@s","bold":false}," --> ",{"text":"Made ","color":"green"},{"selector":"@p[scores={permPNo=$(s)}]","bold":false},{"text":" extremely huge for 30 seconds","color":"green"}]
