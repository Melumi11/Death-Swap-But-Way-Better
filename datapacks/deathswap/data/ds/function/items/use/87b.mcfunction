...
$execute as @p[scores={permPNo=$(s)}] at @s run fill ~7 -62 ~10 ~-8 0 ~-5 minecraft:air
$execute as @p[scores={permPNo=$(s)}] at @s run fill ~7 1 ~10 ~-8 64 ~-5 minecraft:air
$execute as @p[scores={permPNo=$(s)}] at @s run fill ~7 65 ~10 ~-8 128 ~-5 minecraft:air
$execute as @p[scores={permPNo=$(s)}] at @s run fill ~7 129 ~10 ~-8 192 ~-5 minecraft:air
